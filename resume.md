...
<h4 style="color: #05bf85">SKILLS</h4>

**Languages**: Python, Java, JavaScript, SQL, C, MatLab, HTML, CSS  
**Tools and Libraries**: React.js, Node.js, Selenium, UNIX, JIRA, Git, GraphQL  
**Interpersonal**: Communication, Teamwork, Self-Motivation, Determination  
...
<h4 style="color: #05bf85">PROJECTS</h4>

###### Maintenance of [Wiki.js Instance](https://wiki.ourcanadian.ca/)
